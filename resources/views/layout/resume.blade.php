            ...
            <div class="col-md-9">
                <div id="page-1" class="page one">
                    ...
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <h2>SSC</h2>
                            <span class="position">Shree L.D. Mooni High School Sihor</span>
                            <p></p>
                        </div>
                    </div>
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <h2>HSC</h2>
                            <span class="position">R.K. GHARSHALA VINAY MANDIR - Bhavnagar</span>
                    ...
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <span class="position">Sir Bhavsinhji Polytechnic Institute, Bhavnagar</span>
                    ...
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            <span class="date">2019-2021</span>
                            <h2>Online Course On Full Stack Web Devloper</h2>
                            <span class="position">Edufilx</span>
                ...
                <div id="page-2" class="page two">
                    ...
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            <span class="date">15/05/2022-15/08/2022</span>
                            <h2>Trulloy Software Services </h2>
                            <span class="position"> Internship in Web Devlopment</span>
                        </div>
                    </div>
                </div>
